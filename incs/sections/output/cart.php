                    ...
                    <table class="cart-table">
                        ...
                        <tbody>
                            <tr>
                                <td class="prod-column">
                                    <div class="column-box">
                                        <figure class="prod-thumb"><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/resource/shop/prod-thumb-4.jpg" alt="Hand Shovel" title="Hand Shovel"></a></figure>
                                        <h4>Hand Shovel</h4>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td class="prod-column">
                                    <div class="column-box">
                                        <figure class="prod-thumb"><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/resource/shop/prod-thumb-5.jpg" alt="Flower Pot" title="Flower Pot"></a></figure>
                                        <h4>Flower Pot</h4>
                                    </div>
                                </td>
